  ...
  <body>
    <main>
      ...
      <section id="dos">
        ...
        <div class="section-tours pb">
          <div class="tours">
            ...
            <form action="form.php" method="post">
              ...
              <p id="mensaje-exito" style="display: none;">Enviado correctamente</p>
        ...
        <div class="contact">
          <div>
            <img src="./images/mail.svg" alt="mail" /><p class="icons-text">explorebeyond@gmail.com</p>
          </div>
          <div>
            <img src="./images/insta.svg" alt="insta" /><p class="icons-text">@explorebeyoudtours</p>
          </div>
          <div>
            <img src="./images/face.svg" alt="face" /><p class="icons-text">Explore Beyond Tours</p>
          </div>
        </div>
      </section>
    </main>
