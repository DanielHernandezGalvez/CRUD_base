          ...
          text-[--brown]  z-10 overflow-y-auto w-full h-full">
                    ...
                    <div className="font-bold  text-base px-6 py-6">
                        ...
                        <div className="flex justify-center items-center  flex-col">
                            ...
                            >
                                <span className="text-start text-xl ">1. TU INSCRIPCION ES GRATIS  </span> <br /> <br />
                                <span>¿Cómo hacerlo?</span>
                                <br />
                                Entras en contacto con nosotros :<br />
                                1. Via Whatsapp y nos mandas un mensaje al 33 1302 2587 y te apoyamos<br />
                                2. Via Instagram : <a className="text-[--gray] underline" href="https://instagram.com/aceitunaexperience/" target="_blank">Click aqui</a>
                                , nos mandas un mensaje y te apoyamos<br />
                                3. Via Facebook :<a className="text-[--gray] underline" href="https://www.facebook.com/profile.php?id=61554323523242&locale=es_LA" target="_blank">Click aqui</a>,
                                nos mandas un mensaje y te apoyamos<br />
                                4. Via nuestra pagina web : www.aceitunaexperience.com
                                En el Menu, teclas “Contacto”, nos mandas un mensaje y te apoyamos<br />
                                ...
                                <span className="text-xl">2. PUEDES CONSULTAR EL CALENDARIO DE ACTIVIDADES ASI :</span><br /> <br />
                                ...
                                <span className="text-start text-xl">3. PARA RESERVAR O APUNTARTE A UNA ACTIVIDAD ES MUY FACIL :</span><br /> <br />
                                ...
                                <span className="text-start text-xl">5. HAY MEMBRESIAS CON BENEFICIOS :</span><br /> <br />
                                ...
                                hacer el pago<br /> <br />
                                <span className="text-start text-xl">6. DONDE SE HACEN LAS ACTIVIDADES ?</span><br /> <br />
                                ...
                                <span className="text-start text-xl">7. MAS PREGUNTAS ?</span><br /> <br />
