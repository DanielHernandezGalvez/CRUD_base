      ...
      <main class="bg-[--yellow]">
        <section class="hero">
          ...
          >
            ...
            >ACEITUNA</span>
            <p class="text-[--brown] lg:text-xl md:text-sm sm:text-sm mt-10 px-4">
            ...
            <br />
            <p class="text-[--gray] lg:text-xl md:text-sm sm:text-sm pb-5 px-4">
          ...
          <div class="mx-auto pb-5">
            ...
            <div class="flex justify-center gap-10 flex-wrap mt-10" id="boxes">
              <div
                ...
                onClick={() => openModal('Con Aceituna, descubrirás que al participar en diversas actividades, ya sean físicas, artísticas, intelectuales, de bien estar, ampliarás tus horizontes y fortalecerás tu conocimiento. Cada experiencia es una oportunidad para aprender y empoderarte, mostrándote que el aprendizaje va más allá de las aulas, se encuentra en cada acción que emprendes.')}
              >
                Conocimiento
              </div>
              <div
                className="flex justify-center items-center text-3xl cursor-pointer"
                onClick={() => openModal('Unete a nuestras emocionantes actividades! Participar te brinda la oportunidad de formar parte de una vibrante comunidad, Aceituna; ampliar tu circulo social y establecer conexiones significativas. Descubre nuevas amistades, comparte experiencias y enriquece tu vida siendo parte activa de nuestro grupo. Te esperamos para crear juntos momentos inolvidables !')}
              >
                Comunidad
              </div>
              <div
                className="flex justify-center items-center text-3xl cursor-pointer"
                onClick={() => openModal('Formar parte de nuestra comunidad brinda la oportunidad de compartir actividades y vivencias enriquecedoras. Al colaborar y participar, creamos un tejido social que no solo fortalece el bien estar colectivo, sino que también contribuye a nuestro propio crecimiento personal. Al sumergirnos en experiencias compartidas, encontramos satisfacción y realización, construyendo un camino hacia un bien estar más completo y significativo.')}
              >
                Bienestar
              </div>
